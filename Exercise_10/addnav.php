<?php
	...
	if(isset($_POST['addnav'])){
		...
		//Simple salidacija
		if(empty($name = $_POST['ime']) || empty($link = $_POST['link'])){
			
			$error_msg = "Input polja su obavezna, molimo da popunite ista.";
			
		}else{
			
			$sql_insert = mysqli_query($conn, "INSERT INTO nav_meni1(ime, link) VALUES ('$ime', '$link')");
	...
	<form action="" method="post">
		<table class="noborder">
			<tr>
				...
				<td class="noborder"><input class="input-form-nav" type="text" name="ime" /></td>
			</tr>
			<tr>
